...
function Card({
  ...
  return (
    <Component
      ...
      data-size={size}
      className={cn(
        "group/card bg-card text-card-foreground flex flex-col gap-4 overflow-hidden border-2 py-4 text-sm has-data-[slot=card-footer]:pb-0 has-[>div:first-child]:pt-0 has-[>img:first-child]:pt-0 data-[size=sm]:gap-3 data-[size=sm]:py-3 data-[size=sm]:has-data-[slot=card-footer]:pb-0",
        className
      )}
      {...props}
    />
